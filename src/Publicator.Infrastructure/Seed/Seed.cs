    ...
    public static class Seed
    {
        public static void AddData(ModelBuilder builder)
        {
            ...
            var community1 = new Community()
            {
                ...
                PictureUrl = "https://res.cloudinary.com/dgepkksyl/image/upload/v1590193947/user_pics/cars2_c5wyqk.jpg"
            };
            var community2 = new Community()
            {
                ...
                CreationDate = DateTime.Now,
                CreatorUserId = user1.Id,
                PictureUrl = "https://res.cloudinary.com/dgepkksyl/image/upload/v1590193942/user_pics/sport2_fs0yab.jpg"
            };
            ...
            var community3 = new Community()
            {
                ...
                CreationDate = DateTime.Now,
                CreatorUserId = user1.Id,
                PictureUrl = "https://res.cloudinary.com/dgepkksyl/image/upload/v1590193991/user_pics/food2_uckrcb.jpg"
            };
            ...
            var community4 = new Community()
            {
                ...
                CreationDate = DateTime.Now,
                CreatorUserId = user1.Id,
                PictureUrl = "https://res.cloudinary.com/dgepkksyl/image/upload/v1590193952/user_pics/programing_wlmjj4.jpg"
            };
            ...
            var community5 = new Community()
            {
                ...
                CreationDate = DateTime.Now,
                CreatorUserId = user1.Id,
                PictureUrl = "https://res.cloudinary.com/dgepkksyl/image/upload/v1590193976/user_pics/culture2_hdclpb.jpg"
            };
            // seed subscriptions
