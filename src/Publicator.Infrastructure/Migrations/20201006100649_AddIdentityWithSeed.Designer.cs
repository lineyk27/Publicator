...
namespace Publicator.Infrastructure.Migrations
{
    ...
    [Migration("20201006100649_AddIdentityWithSeed")]
    partial class AddIdentityWithSeed
    {
            ...
            modelBuilder.Entity("Publicator.Infrastructure.Models.Community", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5abf6839-2d26-4828-bbd8-e00b1cf37c0a"),
                            CreationDate = new DateTime(2020, 10, 6, 13, 6, 47, 175, DateTimeKind.Local).AddTicks(918),
                            CreatorUserId = new Guid("f71f74d5-4f5a-4947-9550-9b1488d29544"),
                        ...
                        new
                        {
                            Id = new Guid("3dda3403-b576-4fe0-8b77-85f33e85ab59"),
                            CreationDate = new DateTime(2020, 10, 6, 13, 6, 47, 175, DateTimeKind.Local).AddTicks(4944),
                            CreatorUserId = new Guid("f71f74d5-4f5a-4947-9550-9b1488d29544"),
                        ...
                        new
                        {
                            Id = new Guid("fe153742-9a55-4475-8b11-a717cc19e7de"),
                            CreationDate = new DateTime(2020, 10, 6, 13, 6, 47, 175, DateTimeKind.Local).AddTicks(5004),
                            CreatorUserId = new Guid("f71f74d5-4f5a-4947-9550-9b1488d29544"),
                        ...
                        new
                        {
                            Id = new Guid("10232a6a-7180-46b8-8619-650be1e27e9e"),
                            CreationDate = new DateTime(2020, 10, 6, 13, 6, 47, 175, DateTimeKind.Local).AddTicks(5013),
                            CreatorUserId = new Guid("f71f74d5-4f5a-4947-9550-9b1488d29544"),
                        ...
                        new
                        {
                            Id = new Guid("b66c829b-9736-4a14-adb3-80668b0a4c65"),
                            CreationDate = new DateTime(2020, 10, 6, 13, 6, 47, 175, DateTimeKind.Local).AddTicks(5033),
                            CreatorUserId = new Guid("f71f74d5-4f5a-4947-9550-9b1488d29544"),
            ...
            modelBuilder.Entity("Publicator.Infrastructure.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f71f74d5-4f5a-4947-9550-9b1488d29544"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b0a67828-b4ab-447e-8a67-bf655b316d44",
                            Email = "lineyk27gg@gmail.com",
                            EmailConfirmed = false,
                            JoinDate = new DateTime(2020, 10, 6, 13, 6, 47, 167, DateTimeKind.Local).AddTicks(2501),
                        ...
                        new
                        {
                            Id = new Guid("61175164-ed74-4605-bf09-d22fcb4d72e7"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c004b704-2a5f-4081-ac87-2378f62e51bb",
                            Email = "lineyk27@gmail.com",
                            EmailConfirmed = false,
                            JoinDate = new DateTime(2020, 10, 6, 13, 6, 47, 174, DateTimeKind.Local).AddTicks(6442),
                            LockoutEnabled = false,
            ...
            modelBuilder.Entity("Publicator.Infrastructure.Models.UserSubscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2ec9827a-7e04-4d9c-a473-3d5103965cbf"),
                            SubscriberUserId = new Guid("f71f74d5-4f5a-4947-9550-9b1488d29544"),
                            SubscriptionUserId = new Guid("61175164-ed74-4605-bf09-d22fcb4d72e7")
                        });
                });
